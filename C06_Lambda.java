...
public class C06_Lambda  {
	...
	public static void main(String[] args) throws IOException  {
        ...
        Files.
        lines(Paths.get("src/Lambda/haluk.txt")).//file erisip  file satirlari akis alindi
        map(String::toUpperCase).//akýsdaki satirlarin byk hrf ile update edildi
        forEach(System.out::println);
        ...
        System.out.println(Files.
               ...
               flatMap(Arrays::stream).//Arrays clasýndan stream() ile array elemanlarindan yeni bir akýs olusturdu
               distinct().//yeni akýsdaki array elemanlari tekrarsýz hale getirildi
              // toList());
               collect(Collectors.toList()));//yeni akýsdaki array tekrarsýz elemanlari liste atandi
